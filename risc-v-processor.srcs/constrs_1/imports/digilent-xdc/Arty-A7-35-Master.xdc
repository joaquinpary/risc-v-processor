...
set_clock_groups -name mmcm_clk_group \
    -group [get_clocks -of_objects [get_pins u_clk_wiz/inst/mmcm_adv_inst/CLKOUT0]]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { tx_pin }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN A9    IOSTANDARD LVCMOS33 } [get_ports { rx_pin }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
